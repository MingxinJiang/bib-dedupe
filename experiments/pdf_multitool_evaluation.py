...
Example:
    python pdf_multitool_evaluation.py exp_mis/mis-quarterly
    python pdf_multitool_evaluation.py exp_jmis/journal-of-information-technology

Output:
- evaluation.csv, current_results.md, false_positive_multitools.csv
- Output dir: experiments_output/output_<dataset>_multiTool/pdf_only/
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python pdf_multitool_evaluation.py <dataset_root>")
        print("Example: python pdf_multitool_evaluation.py exp_mis/mis-quarterly")
        sys.exit(1)
