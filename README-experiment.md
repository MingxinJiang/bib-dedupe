# Experiments (opt-title-equals-journal branch)

This branch is the "title approximately equals journal name" optimization for bib-dedupe.
It detects titles that are essentially the journal name (pdf_only + no DOI),
then downweights title similarity so other fields dominate matching.
